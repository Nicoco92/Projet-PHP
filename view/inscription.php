...
<div class="name-field">
    ...
    <div><label>Nom</label> <input type="text" name="nom"></div><br>
    <div><label>Prénom</label> <input type="text" name="prenom"></div><br>
    <div><label>Téléphone</label><input type="text" name="tel"></div><br>
